...
import { ArrowBigRightDash, Coins, Contact, File, FileArchive, Home, Info, LayoutDashboard, LucideTrendingDown, LucideTrendingUp, ShowerHead, SidebarClose, X } from 'lucide-react';
...
function Sidebar() {
    ...
    return (
        ...
        <div
            className={`h-full w-64 bg-gray-800 text-white fixed top-0 transition-transform duration-300 ${
        ...
        >
            <div className="p-4">
                            <div className="flex justify-between">
                                ...
                                <button type="button" onClick={() => setShowSidebar(prev => !prev)}><X /></button>
                            </div>
        ...
        {!showSidebar && (
            <button
                ...
                type="button"
                className="h-12 w-12 p-3 bg-gray-800 text-white fixed -left-2 hover:translate-x-2 transition-transform duration-300"
            >
                <ArrowBigRightDash />
            </button>
        )}
